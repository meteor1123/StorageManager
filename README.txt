...
If these 3 methods work, it will reture RC_OK; else, return error codes such as RC_FILE_HANDLE_NOT_INIT,RC_WRITE_FAILED,RC_READ_NON_EXISTING_PAGE and so on.
